...
def parse_option():
    ...
    parser.add_argument('--multi-teacher', type=str2bool, default=False, help='multi teacher  option')
    parser.add_argument('--ls-sl', type=str2bool, default=False, help='enable or disable label smooth single layer')
